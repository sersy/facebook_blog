<div class="topbar stick">
	...
	<div class="top-area">
		...
		<ul>
			<li><a href="{{ route('profile.index',auth()->user()->user_name) }}" >{{ auth()->user()->user_name }}</a></li>
		...
		<ul class="setting-area">
			...
			{{--<li>
				...
				<div class="searched">
					<form method="GET" action="{{ route('search.friend') }}" class="form-search">
						<input type="text" name="find" placeholder="Search Friend">
